...
export default function AlterarSenhaPage() {
  ...
  const handleGoToDashboard = async () => {
    try {
      ...
      console.log("📧 Email:", userEmail)
      console.log("🔑 Primeiro Login:", primeiroLogin)
      
      // Se for primeiro login, fazer login automático
      if (primeiroLogin) {
        console.log("🔐 Fazendo login automático...")
        console.log("📧 Email para login:", userEmail)
        console.log("🔑 Senha para login:", novaSenha ? "***" + novaSenha.slice(-3) : "vazia")
      ...
      console.log("🔄 Redirecionando para login manual...")
